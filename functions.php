...
if ( !function_exists(core_mods) ) {
	function core_mods() {
		if ( !is_admin() ) {
			wp_register_style( 'select-css', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.7.3/css/bootstrap-select.min.css', array('twitter-bootstrap-css') );
			wp_register_style( 'styles', get_stylesheet_directory_uri().'/_/css/styles.css', array('twitter-bootstrap-css, select-css'), filemtime( get_stylesheet_directory().'/_/css/styles.css' ), 'screen' );
			...
			wp_register_script( 'functions', get_stylesheet_directory_uri() . '/_/js/functions-min.js', array('jquery', 'jquery-ui-core', 'bootstrap-all-min', 'jquery-cookie', 'slim-scroll', 'wow-js'), '1.0.1', true );
