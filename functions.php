...
if ( !function_exists(core_mods) ) {
	function core_mods() {
		if ( !is_admin() ) {
			...
			wp_register_style( 'styles', get_stylesheet_directory_uri().'/_/css/styles.css', array('select-css', 'font-awesome-four'), filemtime( get_stylesheet_directory().'/_/css/styles.css' ), 'screen' );
